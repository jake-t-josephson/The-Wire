...
export const CHANNELS: Record<string, ChannelInfo> = {
  ...
  "Netflix":  { label: "Netflix",    url: "https://www.netflix.com",           domain: "netflix.com"      },
  "Prime Video": { label: "Prime Video", url: "https://www.amazon.com/primevideo", domain: "primevideo.com" },
